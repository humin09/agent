...
请求示例:
```bash
curl -X POST 'http://glm5-int8.zzai2.scnet.cn:58000/v1/chat/completions' \
  -H 'Content-Type: application/json' \
  -d '{
    "model": "GLM-5",
    "messages": [{"role": "user", "content": "你好"}],
...
OpenAI Responses 示例:
```bash
curl -X POST 'http://glm5-int8.zzai2.scnet.cn:58000/v1/responses' \
  -H 'Content-Type: application/json' \
  -d '{
    "model": "GLM-5",
    "input": "你好，请用一句话介绍你自己",
...
### qwen36-27b-tp2
- http://qwen36-27b-tp2.zzai2.scnet.cn:58000:/v1/models ✅
- Anthropic 协议: ✅
- OpenAI Responses 协议: ✅
- Responses 多轮对话: 示例，未实测
- Responses 工具调用: ✅
...
请求示例:
```bash
curl -X POST 'http://qwen36-27b-tp2.zzai2.scnet.cn:58000/v1/chat/completions' \
  -H 'Content-Type: application/json' \
  -d '{
    "model": "Qwen3.6-27B",
    "messages": [{"role": "user", "content": "你好"}],
...
OpenAI Responses 示例:
```bash
curl -X POST 'http://qwen36-27b-tp2.zzai2.scnet.cn:58000/v1/responses' \
  -H 'Content-Type: application/json' \
  -d '{
    "model": "Qwen3.6-27B",
    "input": "你好，请用一句话介绍你自己",
